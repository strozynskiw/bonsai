...
pub(in crate::tui) use providers::handle_providers_command;
use providers::{
    open_provider_detail, open_provider_manager, open_provider_manager_edit,
    provider_manager_remove_selected, submit_provider_remove_confirm,
};
...
mod tests {
    ...
    fn provider_builtin_detection_covers_catalog_builtins() {
        ...
        assert!(super::providers::provider_is_builtin(&codex));
        assert!(super::providers::provider_is_builtin(&openai_compatible));
        assert!(!super::providers::provider_is_builtin(&custom));
    }
