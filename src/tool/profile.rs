...
pub(crate) const TOOL_DESCRIPTORS: &[ToolDescriptor] = &[
    ...
    descriptor(
        ...
        LocalState,
        Serialized,
        [ABSENT, 31, ABSENT, ABSENT, ABSENT],
        [false; 5],
        Standard,
    ),
    descriptor(
